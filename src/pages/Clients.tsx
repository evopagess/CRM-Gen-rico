        ...
        <CardContent>
          {filteredClients.length === 0 ? (
            <div className="text-center py-20 text-zinc-500">
              ...
              <p className="text-xl font-bold text-zinc-900 tracking-tight">Nenhum cliente encontrado</p>
              <p className="text-sm mt-2 font-medium">Cadastre um novo cliente para começar a gerar orçamentos.</p>
            </div>
          ) : (
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {filteredClients.map(client => (
                <div key={client.id} className="border border-zinc-200 rounded-[2rem] p-6 hover:border-brand-500 hover:shadow-premium transition-all group relative bg-white">
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      <h3 className="text-xl font-black text-zinc-900 group-hover:text-brand-600 transition-colors truncate italic uppercase tracking-tighter">{client.name}</h3>
                    ...
                    <div className="flex flex-row sm:flex-col gap-2 ml-2 sm:ml-4">
                      <button
                        ...
                        className="p-3 rounded-xl bg-zinc-50 border border-zinc-100 hover:bg-zinc-100 text-zinc-500 hover:text-brand-600 transition-all active:scale-90"
                        title="Editar"
                      >
                        <Edit2 size={20} />
                      </button>
                      <button
                        ...
                        className="p-3 rounded-xl bg-zinc-50 border border-zinc-100 hover:bg-zinc-100 text-zinc-500 hover:text-rose-600 transition-all active:scale-90"
                        title="Excluir"
                      >
                        <Trash2 size={20} />
                      </button>
